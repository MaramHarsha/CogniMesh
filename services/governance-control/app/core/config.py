...
def get_settings() -> Settings:
    return Settings(
        service_name=os.getenv("COGNIMESH_SERVICE_NAME", "cognimesh-governance-control"),
        ...
        state_path=os.getenv(
            "COGNIMESH_GOVERNANCE_STATE_PATH",
            "/var/lib/cognimesh/governance-control/governance.db",
        ),
